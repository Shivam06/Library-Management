...
$("#recieved-button").click(function(){
	...
	event_recieve_confirmed.watch(function(){
		$("#output-one").html("Recieve Confirmed! Your ethers have been transferred to your account.")
